...
public class SubscriptionTiersController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        var response = _client.GetAsync(_client.BaseAddress + "/GetSubscriptionTiers").Result;
    ...
    public async Task<IActionResult> DeleteConfirmed(int SubscriptionTierID)
    {
        try
        {
            ...
            string deleteUrl = $"{_client.BaseAddress}/DeleteSubscriptionTier/{SubscriptionTierID}";
    ...
    public IActionResult Edit(int id, UpdateSubscriptionTierDTO updateSubscriptionTierDTO)
    {
        ...
        string url = _client.BaseAddress + $"/PutSubscriptionTier/{id}";
    ...
    public IActionResult Create(CreatSubscriptionTierDTO subscriptionTier)
    {
        ...
        var response = _client.PostAsync(_client.BaseAddress + "/PostSubscriptionTier", jsonContent).Result;
